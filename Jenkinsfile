    ...
    stages {
        ...
        stage('build') {
            steps {
                ...
                sh 'curl -L https://github.com/tcnksm/ghr/releases/download/v0.13.0/ghr_v0.13.0_linux_amd64.tar.gz | tar -zxv -C /usr/local/bin --strip-components=1 ghr_v0.13.0_linux_amd64/ghr'
